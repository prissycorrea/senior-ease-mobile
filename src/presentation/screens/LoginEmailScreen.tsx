...
export function LoginEmailScreen({
  ...
  const canNext = isPlausibleEmail(email);
  ...
  const handleVoicePress = useCallback(() => {
    Alert.alert(
      "Voz",
      "Em breve você poderá ditar o e-mail para entrar na conta.",
      [{ text: "OK" }],
    );
  }, []);
  ...
  const handlePrivacyIconPress = useCallback(() => {
    Alert.alert(
      "Privacidade",
      "Seu e-mail é usado apenas para identificar sua conta neste aplicativo.",
      [{ text: "OK" }],
    );
  }, []);
      ...
      <SafeAreaView style={styles.safe} edges={["left", "right", "bottom"]}>
        ...
        >
          ...
          >
            ...
            >
              Digite ou use a sua voz para informar o e-mail da sua conta.
            </Text>
            ...
            >
              ...
              />
              <Pressable
                testID="login-email-privacy-icon"
                ...
                accessibilityRole="button"
                accessibilityLabel="Informação de privacidade do e-mail"
              >
                <Ionicons
            ...
            <Pressable
              testID="login-email-voice-button"
