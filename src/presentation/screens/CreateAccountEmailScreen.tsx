...
export function CreateAccountEmailScreen({
  initialEmail,
  onBack,
  onNext,
}: Props): ReactElement {
  ...
  const handlePrivacyIconPress = useCallback(() => {
    Alert.alert(
      "Privacidade",
      "Seu e-mail é usado apenas para acesso à conta e comunicações do app.",
      [{ text: "OK" }],
    );
  }, []);
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <Pressable
                testID="sign-up-email-privacy-icon"
